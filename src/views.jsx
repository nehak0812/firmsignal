          ...
          <div style={{
            ...
            <div style={{ borderBottom: '1px solid var(--line)', paddingBottom: 12, marginBottom: 20 }}>
              ...
              <h3 style={{ fontFamily: 'var(--serif-disp)', fontSize: 18, margin: '4px 0 0 0', color: 'var(--ink)' }}>
                AI Synthesized Comparative Insights &amp; Strategic Themes (FY2025)
              </h3>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
              ...
              {/* Insight 4: Sustainability & ESG Commitments */}
              <div style={{ background: 'var(--bg)', padding: 16, borderRadius: 'var(--r-md)', border: '1px solid var(--line)' }}>
                <h4 style={{ margin: '0 0 10px 0', fontFamily: 'var(--mono)', fontSize: 11.5, color: 'var(--teal)', display: 'flex', alignItems: 'center', gap: 6 }}>
                  🌱 Sustainability &amp; ESG Transition
                </h4>
                <p style={{ margin: 0, fontSize: 12.5, color: 'var(--ink-2)', lineHeight: 1.5, fontFamily: 'var(--serif)' }}>
                  Sustainability advisory has matured into a core compliance line. <b>Deloitte</b> and <b>PwC</b> report double-digit growth in green transition engagements, driven by corporate preparations for the EU's CSRD and global climate rules. <b>Accenture</b> has integrated carbon tracking metrics directly into its digital transformation delivery platforms, while <b>EY</b> has achieved carbon negative status across its global operations by offsetting scope 1 and 2 emissions through certified carbon sink investments.
                </p>
              </div>

              {/* Insight 5: M&A & Strategic Acquisitions */}
              <div style={{ background: 'var(--bg)', padding: 16, borderRadius: 'var(--r-md)', border: '1px solid var(--line)' }}>
                <h4 style={{ margin: '0 0 10px 0', fontFamily: 'var(--mono)', fontSize: 11.5, color: 'var(--crit)', display: 'flex', alignItems: 'center', gap: 6 }}>
                  🤝 M&amp;A Strategy &amp; Acquisitions
                </h4>
                <p style={{ margin: 0, fontSize: 12.5, color: 'var(--ink-2)', lineHeight: 1.5, fontFamily: 'var(--serif)' }}>
                  Firms are aggressively buying niche capabilities to scale digital pipelines. <b>Accenture</b> deployed over $2.5B on acquisitions in FY25, targeting cloud migration, cyber defense, and regional creative studios. <b>Deloitte</b> focused on regional AI engineering boutiques (e.g. SFL Scientific), while <b>PwC</b> and <b>KPMG</b> prioritized strategic tuck-in acquisitions in digital identity management, supply chain logistics, and sovereign database security.
                </p>
              </div>

              {/* Insight 6: Shift in Billing & Operating Models */}
              <div style={{ background: 'var(--bg)', padding: 16, borderRadius: 'var(--r-md)', border: '1px solid var(--line)' }}>
                <h4 style={{ margin: '0 0 10px 0', fontFamily: 'var(--mono)', fontSize: 11.5, color: 'var(--purple)', display: 'flex', alignItems: 'center', gap: 6 }}>
                  ⚖️ FTE Pricing vs. Outcome Billing
                </h4>
                <p style={{ margin: 0, fontSize: 12.5, color: 'var(--ink-2)', lineHeight: 1.5, fontFamily: 'var(--serif)' }}>
                  The hourly billing framework is under severe commoditization pressure from AI agents. <b>EY</b> and <b>PwC</b> reports emphasize transitioning legacy accounts from FTE headcounts to outcome-based and subscription-based pricing. <b>Accenture</b>'s 'Total Enterprise Reinvention' delivery model prioritizes deploying autonomous agent architectures, shifting client KPIs from consulting hours to business throughput metrics.
                </p>
              </div>
            </div>
          </div>
